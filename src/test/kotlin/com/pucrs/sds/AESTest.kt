...
class AESTest {
    ...
    fun task1() {
        ...
        val actual = AES.decrypt(key, cipher, CBC)
    ...
    fun task3() {
        ...
        val actual = AES.decrypt(key, cipher, CTR)
    ...
    fun task5() {
        ...
        val cipher = AES.crypt(key, plainText, CTR)
        val actual = AES.decrypt(key, cipher, CTR)
    ...
    fun task6() {
        ...
        val cipher = AES.crypt(key, plainText, CBC)
        val actual = AES.decrypt(key, cipher, CBC)
